...
the following will show revised version doc from pybitcointool
...
tx2 = sign(tx,0,priv) # 0 is for get the prev out
print(tx2)
...
tx3 = sign(tx2,1,priv) # 1 is for get the prev out because this is a second time
print(tx3)
